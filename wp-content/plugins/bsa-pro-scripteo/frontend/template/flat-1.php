...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-flat-1" class="bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-flat-1 bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
