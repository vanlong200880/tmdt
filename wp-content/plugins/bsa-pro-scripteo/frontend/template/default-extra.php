...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-default-extra" class="bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-default-extra bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
