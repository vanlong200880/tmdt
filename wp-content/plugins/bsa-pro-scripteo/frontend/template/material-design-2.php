...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-material-design-2" class="bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-material-design-2 bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
