				...
				<div class="all-content-user">
					<div class="title-form-user">
						<h2>
							...
							<?php echo ($language == 'en')?'List post':'Danh sách bài đăng'; ?>
							<div class="status">
								<span><?php echo ($language == 'en')?'Filter':'Trạng thái'; ?></span>
								<select name="user-post-user" id="user-post-filter">
                  <option value="<?php echo get_site_url() ?>/list-post/"><?php echo ($language == 'en')?'-- All --':'-- Tất cả --'; ?></option>
									<option <?php echo ($_GET['filter'] == 'publish')?'selected':''; ?> value="<?php echo get_site_url() ?>/list-post/?filter=publish"><?php echo ($language == 'en')?'Published':'Đã post'; ?></option>
									<option <?php echo ($_GET['filter'] == 'pending')?'selected':''; ?> value="<?php echo get_site_url() ?>/list-post/?filter=pending"><?php echo ($language == 'en')?'Pending':'Chờ duyệt'; ?></option>
								</select>
							</div>
						</h2>
					</div>
