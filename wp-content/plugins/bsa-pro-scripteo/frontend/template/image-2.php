...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-image-2" class="bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-image-2 bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
