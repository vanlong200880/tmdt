...
// -- START -- TEMPLATE HTML
echo '<div id="bsa-default" class="bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-default bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
