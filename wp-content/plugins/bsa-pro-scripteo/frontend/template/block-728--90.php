...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-'.$template_name.'" class="bsaProBlock bsaProContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").$template_name.' bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
	...
	foreach ( $ads as $key => $ad ) {
		...
		echo '<div class="bsaProItemInner__img" style="background-image: url(&#39;'.bsa_crop_tool($crop, ((!isset($sid) && !isset($_POST['bsa_ad_id'])) ? $ad['img'] : bsa_upload_url().$ad['img']), 728, 90).'&#39;)"></div>'; // -- ITEM -- IMG
