...
if($cats){
	?>
<section class="all-article list-category-home">
  <div class="container">
    <div class="row">
	<?php 
	$count = 1;
                                      ...
                                      <p class="title">
										...
										<div class="wrapp-info">
                                          ...
                                          <div class="price-bds">
                                            ...
                                            <p class="dien-tich">
                                              <strong>Diện tích</strong><br> <span><?php echo get_field('dien_tich'); ?>m<var>2</var></span>
                                            </p>
                                          </div>
                                          <?php endif; ?>
                                          
											<p class="address <?php echo $class; ?>">
										...
										<figcaption>
                                          <p class="title">
                                            ...
                                            <?php if(get_field('gia')): ?>
                                              <p class="price">
                                                <strong>Giá:</strong> <span><?php echo get_field('gia'); ?></span>
                                              </p>
                                            <?php endif; ?>
                                              <?php if(get_field('dien_tich')): ?>
                                              <p class="dien-tich">
                                              <strong>Diện tích:</strong> <?php echo get_field('dien_tich'); ?>
                                            </p>
                                            <?php endif; ?>
											<?php if($category_cat && $category_cat[0]->slug != 'nguon-dia-oc'):
                                          ?>
											<p class="description">
												<?php echo the_excerpt_max_charlength(12); ?>
											</p>
