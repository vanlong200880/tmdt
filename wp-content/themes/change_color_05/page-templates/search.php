	...
	<div class="container">
      ...
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><h1 class="title-h1">Tìm kiếm </h1></li>
        </ol>
      </div>
    </div>
          ...
          <div class="col-md-8 col-sm-8 col-xs-12 show-search">
              ...
              <?php 
                ...
                while ($my_the_query->have_posts()){
                  ...
                  if (!empty($attachment_id)) { 
                    $img = get_the_post_thumbnail(get_the_ID(),array($width,$height), array('title' => get_the_title()));
                  }else{
                  ...
                  $jsonData[] = array(
                    ...
                    'lat' => $dataLatLng[1],
                    'address' => '',
                    'description' => '<p class="description">'.the_excerpt_max_charlength(18).'</p>',
                    'vote' => '<div class="fs-comment"><span>Bình chọn:</span>'.$ratings.'</div>',
                    'img' => $img,
            ...
            <div class="row">
              <div class="paging col-md-12">
                <?php	 
                wp_pagenavi(array('query' => $my_the_query )) ;	
                ?>
              </div>
            </div>
          </div>
          ...
          <div <?php echo (!wpmd_is_iphone()) ? 'id="sidebar"': ''; ?> class="col-md-4 col-sm-4 col-xs-12 search-repend">
            ...
            <div class="show-map"></div>
              ...
              <script>
                ...
                function createMarker(latlng,name,html,color, address, vote, baseurl, img, hot, description) {
        ...
        //            mapTypeControlOptions: {style: google.maps.MapTypeControlStyle.DROPDOWN_MENU},
                  ...
                  google.maps.event.addListener(map, 'click', function() {
                    ...
                    for (var i = 0; i < beaches.length; i++) {
                      ...
                      var img = beach.img;
                      var hot = beach.hot;
                      var description = beach.description;
                      // create the marker
                      var marker = createMarker(point,label,html,"blue", address, vote, baseurl, img,hot ,description);
                    }
